...
ROOT_DIR="$(pwd)"
SWAGGER_DIR="src/app/client/swagger"
TEMP_FILE="$ROOT_DIR/temp.json"
AUTOREST_API_DEFAULT="http://localhost:5070/swagger/v1/swagger.json"
...
autorest --input-file="$SWAGGER_DIR/api-spec.json" --typescript --output-folder=src/app/client --debug --verbose

# 📂 Corrige arquivos gerados
cd "$ROOT_DIR/src/app/client"
